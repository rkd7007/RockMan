...
CMyPlayerHpSprite::CMyPlayerHpSprite()
{
	m_nFrame = 0;
...
void CMyPlayerHpSprite::Create(LPDIRECT3DDEVICE9 pDevice, char* filename)
{
...
void CMyPlayerHpSprite::OnDraw()
{
	...
	D3DXVECTOR3 vPosition(10.0f, 0.0f, 0.0f);
...
void CMyPlayerHpSprite::OnUpdate(float time)
{
